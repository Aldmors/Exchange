      ...
      <div className="main fullArticle">
        <div className="fullArticle-content">
            ...
            <div className="data"></div>
                ...
                <a className="bottom-bar clickable" href={article.articleUrl} target="_blank" rel="noreferrer noopener"><div>LINK TO ORIGINAL</div></a>
            <Link className="bottom-bar clickable"to="/news">BACK TO NEWS</Link>
        </div>
      </div>
    </>
  );
